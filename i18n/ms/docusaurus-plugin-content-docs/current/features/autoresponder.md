...
3. Pilih **Text & Media**, tulis mesej, dan tambah media daripada **File manager**, **Upload** atau **Add via URL** jika perlu.
4. Pilih **Normal Mode** atau **AI Reply Mode**.
5. Masukkan nombor yang dikecualikan.
6. Konfigurasikan Lead Management, pemajuan, webhook atau kumpulan kenalan jika diperlukan.
7. Klik **Save** dan uji dengan nombor terkawal.
