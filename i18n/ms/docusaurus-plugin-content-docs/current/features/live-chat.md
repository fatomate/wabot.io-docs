...
5. Gunakan tab maklumat kenalan untuk **General**, **Media** dan **Follow-up** apabila tersedia.

Untuk perbualan API Rasmi dengan **WhatsApp 24h window expired**, gunakan **Send Template** dan bukannya mesej teks biasa. Gunakan nota dalaman hanya untuk pasukan, dan semak mesej berjadual dalam Queue Message atau panel perbualan.
