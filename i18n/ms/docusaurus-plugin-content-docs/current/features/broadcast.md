...
Gunakan **WhatsApp Blast** untuk menghantar kempen kepada kumpulan kenalan atau pelanggan bersegmen. Dalam menu Wabot, ciri ini dipaparkan sebagai **Broadcast**.

## Sebelum menghantar

1. Sambungkan akaun WhatsApp penghantar.
2. Sediakan senarai WhatsApp Blast atau segmen pelanggan.
...
2. **Create Message**: pilih mesej biasa atau templat, tulis mesej, tambah media/placeholder, dan semak pratonton. Poll tidak tersedia untuk WhatsApp Blast API Rasmi.
...
- **Resume** meneruskan penerima layak untuk WhatsApp Blast dijeda, gagal atau dibatalkan.
- **Restart** memulakan semula WhatsApp Blast gagal/dibatalkan.
...
2. Masukkan nama WhatsApp Blast baharu.
